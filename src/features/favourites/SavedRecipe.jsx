...
import { selectAllRecipes } from "../recipes/recipeManagerSlice";
import RemoveButton from "../favourites/RemoveButton"
...
const SavedRecipe = () => {
  ...
  const renderedFavouriteRecipes = Array.isArray(favourites) &&
 favourites.map((item) => (
